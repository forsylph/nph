...
// → devonhome/navigation/mhi/az/bizcom/authNavi.xml 의 CheckLoginUser Action
```
...
### 5.1.1 XML Query 실제 호출 예시
```java
// nph.his.az.zzaz.util.PtstMngmEC
public LMultiData retirevePtstList(LData data) throws LException {
    LCommonDao dao = new LCommonDao("/az/util/azcmmptst/retirevePtstList", data);
