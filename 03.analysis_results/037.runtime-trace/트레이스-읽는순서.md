...
1. [MD_ORD01001P-실행체인.md](./MD_ORD01001P-%EC%8B%A4%ED%96%89%EC%B2%B4%EC%9D%B8.md)
   - 가장 과밀한 대표 화면
   - `.mhi -> command -> PC/UC -> EC -> xmlquery`가 가장 복합적으로 보인다
2. [HP_DMS02204M-실행체인.md](./HP_DMS02204M-%EC%8B%A4%ED%96%89%EC%B2%B4%EC%9D%B8.md)
   - 조회형처럼 보이지만 심사 후처리 도메인 파일군이 함께 묶인 사례
3. [EdiMngmPC-분기구조.md](./EdiMngmPC-%EB%B6%84%EA%B8%B0%EA%B5%AC%EC%A1%B0.md)
...
템플릿은 [실행체인-템플릿.md](./%EC%8B%A4%ED%96%89%EC%B2%B4%EC%9D%B8-%ED%85%9C%ED%94%8C%EB%A6%BF.md) 에 둔다.
